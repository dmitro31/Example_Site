...
export default function Footer() {
  return (
    <footer className="bg-char px-6 pb-10 pt-16 text-cream lg:px-10">
      <div className="mx-auto max-w-7xl border-t border-cream/12 pt-10">
        <div className="flex flex-col justify-between gap-10 lg:flex-row">
          <div>
            <span className="font-display text-2xl font-semibold italic">ЖАР</span>
            <p className="mt-3 max-w-xs text-sm text-cream/50">
              Ресторан живого вогню в Івано-Франківську.
            </p>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-3 text-xs text-cream/35 sm:flex-row sm:items-center sm:justify-between">
          <p>© {new Date().getFullYear()} ЖАР. Усі права захищені.</p>
